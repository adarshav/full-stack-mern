...
1. findProductByPriceRange(products, 2500, 7500)
...
console.log(findProductByPriceRange(products, 2500, 7500));//it returns an empty array if the range is not present if the range is found it returns that range
